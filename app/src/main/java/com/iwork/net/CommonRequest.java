...
public class CommonRequest {
     ...
     * @param callback
     */
    public static void setUserInfo(String en_name, String mail, String company, int experience, String pic, String signature,ResultCallback<CommonModel> callback) {
        Map<String, String> params = new HashMap<>();
        if (!TextUtil.isEmpty(en_name)) {
            params.put(ServerParam.EN_NAME, en_name);
        }
        ...
        if (!TextUtil.isEmpty(signature))
            params.put(ServerParam.SIGNATURE,signature);
        params.put(ServerParam.TOKEN, Preferences.getInstance().getToken());
